...
import by.yakivan.oauthsample.github.Followers;
import by.yakivan.oauthsample.okhttp.LoggingInterceptor;
...
public class FollowersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        textView = v.findViewById(R.id.response_content);
        showFollowers = v.findViewById(R.id.btswitch);
